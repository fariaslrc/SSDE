...
% surrogate-assisted model called self-organized surrogate-assisted 
% non-dominated sorting differential evolution
% num_nodes    ---  N   --- Number of neurons in each dimension of the latent space
% eta0 --- 0.2 --- Initial learning rate
% sigma0    ---  N  --- Size of neighborhood mating pools

%------------------------------- Reference --------------------------------
% A.F.R. Araújo, L.R.C. Farias, and A.R.C. Gonçalves, Self-Organizing 
% Surrogate-Assisted Non-Dominated Sorting Differential Evolution,
        ...
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(Population)
                ...
                if size(Samples,2) >= Problem.N
                    W = Training(Problem, W, LDis, Samples, num_nodes, eta0, sigma0, winning_weights, Population);
