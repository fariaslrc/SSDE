function W = Training(Problem, W, LDis, Samples, num_nodes, eta0, sigma0, winning_weights, Population)
	...
	if any(winning_weights) == true                    
        ...
        if sum(winning_weights) < num_nodes   
            ...
            % Also applying noise to winning nodes
%             W(winning_weights,:) =  W(winning_weights,:) + 0.001.*randn(sum(winning_weights),Problem.D+Problem.M);
